...
NLPの研究室で、LLMの情報の忘却手法(Machine Unlearning)について研究をします。<br>

学部時代は他大学にて数学 (線形代数学・解析学・統計学・グラフ理論・etc..)を学びました。学士論文は推薦システムに関して、ネガティブレビューを考慮したItem2vecのアルゴリズム改善を提案し、ニューラルネットワークを実装して精度の比較まで行いました。<br>
